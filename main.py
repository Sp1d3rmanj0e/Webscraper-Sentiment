...
def get_sentiment_from_url(URL : str, get_sentiment : bool) -> dict:
    ...
    try:
        ...
        outputs = {'positive' : 0.0, 'neutral' : 0.0, 'negative' : 0.0}
...
def get_news_website_urls(topic : str, use_test_data : bool) -> dict:
    ...
    if (use_test_data):
        ...
        return ['https://www.cnbc.com/2024/04/03/stock-market-today-live-updates.html', 
                ...
                'https://www.barrons.com/articles/stock-market-bounces-jobs-report-97bd920b']
...
def main():
    ...
    # Get the stock to assess
    stock_name = input("What stock would you like to assess? ")
    stock_name += " stock"
